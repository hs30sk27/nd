...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED0_Pin|LED1_Pin|RF_TXEN_Pin|RF_RXEN_Pin
  ...
  /*Configure GPIO pins : ICM20948_CS_Pin ADC_CS_Pin */
  GPIO_InitStruct.Pin = ICM20948_CS_Pin|ADC_CS_Pin;
  ...
  /*Configure GPIO pins : LED0_Pin LED1_Pin RF_TXEN_Pin RF_RXEN_Pin
                           ADC_EN_Pin */
  GPIO_InitStruct.Pin = LED0_Pin|LED1_Pin|RF_TXEN_Pin|RF_RXEN_Pin
                          |ADC_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
